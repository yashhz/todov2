                            ...
                            <div className="m-form__section">
                                ...
                                <div className="m-form__row animate-fade-in-up" style={{gap: '12px'}}>
                                    ...
                                    <div style={{position: 'relative', width: '50%'}}>
                                        ...
                                        />
                                        <button type="button" onClick={() => setShowUnitPicker(!showUnitPicker)} style={{position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', background:'transparent', border:'none', color:'var(--text-secondary)', cursor:'pointer'}} aria-label="Toggle unit picker" title="Toggle unit picker">▾</button>
                                    </div>
                                </div>
                            </div>
                        )}
