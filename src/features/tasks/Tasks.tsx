    ...
    return (
        <div className="tf-cal">
            <div className="tf-cal__nav">
                <button type="button" className="tf-cal__nav-btn" aria-label="Previous month" onClick={prev}>‹</button>
                <span className="tf-cal__month">{monthName}</span>
                <button type="button" className="tf-cal__nav-btn" aria-label="Next month" onClick={next}>›</button>
            </div>
                    ...
                    <div className={`m-form__body ${formTitle.trim() ? 'm-form__body--visible' : ''}`}>
                        ...
                        <div className="m-form__section">
                            <div className="m-form__row">
                                ...
                                {formDate && (
                                    <button type="button" className="m-form__clear-date" aria-label="Clear date" onClick={() => { setFormDate(''); setShowCalendar(false); }} style={{background:'transparent', border:'none', color:'rgba(255,255,255,0.25)', cursor:'pointer'}}>×</button>
                                )}
                            </div>
                                ...
                                {formProjectId && (() => {
                                    ...
                                    return (
                                        <span className="m-form__pill m-form__pill--sm" style={{ background: p.color + '18', borderColor: p.color + '55', color: p.color }}>
                                            {p.icon} {p.name}
                                            <button type="button" aria-label="Remove project" onClick={() => setFormProjectId(null)} style={{background:'transparent', border:'none', color:'inherit', marginLeft:'6px', cursor:'pointer'}}>×</button>
                                        </span>
                                    );
                                })()}
