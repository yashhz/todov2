    ...
    return (
        <div className="date-navigator">
            <button className="dn-arrow" onClick={() => {
                ...
                onDateChange(prev);
            }} aria-label="Previous date" title="Previous date"><ChevronLeft size={16} /></button>
            ...
            <button className="dn-arrow" onClick={() => {
                ...
                onDateChange(next);
            }} aria-label="Next date" title="Next date"><ChevronRight size={16} /></button>
        </div>
    );
}
        ...
        <div className="habits-page page-enter">
            ...
            <div className="habits-header">
                ...
                <div className="habits-header__right">
                    <button className="h-add-btn" onClick={() => { resetForm(); setShowForm(true); }} aria-label="Create new habit" title="Create new habit">
                        <span>+</span> New Habit
                    </button>
                </div>
            </div>
            ...
            <div className="habits-grid">
                {filteredHabits.length === 0 ? (
                    <div className="habits-empty">
                        ...
                        <button className="m-add-btn" onClick={() => { resetForm(); setShowForm(true); }} aria-label="Create new habit" title="Create new habit">
                            <span>+</span> New Habit
                        </button>
                    </div>
                ) : (
                    ...
                    <div className={`m-form__body ${formTitle.trim() ? 'm-form__body--visible' : ''}`}>
                        ...
                        <div className="m-form__section m-form__section--row">
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                {formTime && (
                                    <button type="button" onClick={() => setFormTime('')} style={{background:'transparent', border:'none', color:'rgba(255,255,255,0.25)', cursor:'pointer', marginLeft: '8px'}} aria-label="Clear time" title="Clear time">×</button>
                                )}
                                {showTimePicker && (
                            ...
                            <div style={{ position: 'relative', flex: 1, minWidth: '150px' }}>
                                {formProjectId ? (
                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                        ...
                                        <button type="button" onClick={() => setFormProjectId(null)} style={{ background: 'none', border: 'none', color: 'var(--text-tertiary)', cursor: 'pointer', marginLeft: '8px' }} aria-label="Clear project" title="Clear project">×</button>
                                    </div>
                                ) : (
                                    <>
                                        <input
