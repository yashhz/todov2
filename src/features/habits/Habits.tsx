                            ...
                            <div style={{ position: 'relative', flex: 1, minWidth: '150px' }}>
                                {formProjectId ? (
                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                        ...
                                        <button type="button" onClick={() => setFormProjectId(null)} aria-label="Remove project link" title="Remove project link" style={{ background: 'none', border: 'none', color: 'var(--text-tertiary)', cursor: 'pointer', marginLeft: '8px' }}>×</button>
                                    </div>
                                ) : (
                                    <>
                                        <input
