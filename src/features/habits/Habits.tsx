                    ...
                    filteredHabits.map(habit => {
                        ...
                        return (
                            <Card
                                ...
                                actions={
                                    <>
                                        <button className="card__action-btn" aria-label="Edit habit" onClick={e => { e.stopPropagation(); openEdit(habit); }}>
                                            <Edit size={14} />
                                        </button>
                                        <button className="card__action-btn card__action-btn--danger" aria-label="Delete habit" onClick={e => { e.stopPropagation(); deleteHabit(habit.id); }}>
                                            <Trash2 size={14} />
                                        </button>
                                    </>
                                }
